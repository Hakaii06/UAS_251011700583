...
if (isset($_POST['ubah'])) {
    ...
    if (!empty($nama_gambar)) {
        ...
        if (in_array($ekstensi_gambar, $ekstensi_valid)) {
            ...
            // PERBAIKAN SOLUSI VERCEL: Simpan ke folder /tmp/
            ...
            if (move_uploaded_file($tmp_name, $target_upload)) {
                ...
                $error = "Gagal mengunggah gambar baru ke folder /tmp server.";
            }
        } else {
            ...
            <div class="row">
                ...
                <div class="col-12 mb-4">
                    ...
                    <div class="mb-2">
                        ...
                        <img src="/baca_gambar?file=<?= $product['gambar']; ?>" width="65" height="65" class="rounded border object-fit-cover" alt="Current Image">
                    </div>
