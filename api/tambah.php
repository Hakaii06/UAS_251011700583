        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="nama_produk" class="form-control form-control-sm" required autocomplete="off">
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="harga" class="form-control form-control-sm" min="0" required>
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="mb-4">
                <label class="form-label small fw-semibold text-secondary">Unggah Berkas Gambar / Foto</label>
